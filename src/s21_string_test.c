...
//     ck_assert_pstr_eq(strncpy(b1, str_1_2, n1), s21_strncpy(b11, str_1_2,
//     n1));
// } END_TEST
...
//     ck_assert_pstr_eq(strncpy(b2, str_2_2, n2), s21_strncpy(b22, str_2_2,
//     n2));
// } END_TEST
...
//     ck_assert_pstr_eq(strncpy(b3, str_3_2, n3), s21_strncpy(b33, str_3_2,
//     n3));
// } END_TEST
...
// START_TEST(strspn_1) {
//     char str[]= "12-years";
//     ck_assert_int_eq(strspn(str, "1234567890"), s21_strspn(str,
//     "1234567890"));
// } END_TEST
...
//     char res[] =
//     "11111111111111111111111111111111111111111111111111111111111111111111111111111111111113";
//     ck_assert_int_eq(s21_strspn(res, src), strspn(res, src));
// } END_TEST
// // strspn <-
...
//     char expected[49 + 42] = "as[oidjf paijsdf j9oqh2837o4h hUW auhduash
//     W8awd"; s21_strcpy(res, src); strcpy(expected, src);
//     ck_assert_str_eq(res, expected);
// } END_TEST
// strcpy <-
...
//     char src[] = "asd0fj  asd1f aisdfjw6234A1241SD SA5 asDSad
//     89SDAsdw7qqeAS"; char res[5 + 59] = "Hello"; char expected[5 + 59] =
//     "Hello"; s21_strcat(res, src); strcat(expected, src);
//     ck_assert_str_eq(res, expected);
// } END_TEST

// START_TEST(strcat_any_letters_with_register_and_num_and_sim) {
//     char src[] = "asd0fj  asd1f aisdfjw6234A1241SD SA5 asDSad
//     89SDAsdw7qqeAS)(?!.,"; char res[5 + 65] = "Hello"; char expected[5 + 65]
//     = "Hello"; s21_strcat(res, src); strcat(expected, src);
//     ck_assert_str_eq(res, expected);
// } END_TEST
// // strcat <-
...
//     expected[kByte+8]; s21_memmove(res, src, kByte); memmove(expected, src,
//     kByte); ck_assert_mem_eq(res, expected, kByte);
// } END_TEST
