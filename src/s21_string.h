...
char* errorStrings[] = {
        EPERM_STR, ENOENT_STR, ESRCH_STR, EINTR_STR, EIO_STR, ENXIO_STR,
        E2BIG_STR, ENOEXEC_STR, EBADF_STR, ECHILD_STR, EDEADLK_STR, ENOMEM_STR,
        EACCES_STR, EFAULT_STR, ENOTBLK_STR, EBUSY_STR, EEXIST_STR, EXDEV_STR,
        ENODEV_STR, ENOTDIR_STR, EISDIR_STR, EINVAL_STR, ENFILE_STR, EMFILE_STR,
        ENOTTY_STR, ETXTBSY_STR, EFBIG_STR, ENOSPC_STR, ESPIPE_STR, EROFS_STR,
        EMLINK_STR, EPIPE_STR, EDOM_STR, ERANGE_STR, EAGAIN_STR, EINPROGRESS_STR,
        EALREADY_STR, ENOTSOCK_STR, EDESTADDRREQ_STR, EMSGSIZE_STR, EPROTOTYPE_STR, 
        ENOPROTOOPT_STR, EPROTONOSUPPORT_STR, ESOCKTNOSUPPORT_STR, ENOTSUP_STR,
        EPFNOSUPPORT_STR, EAFNOSUPPORT_STR, EADDRINUSE_STR, EADDRNOTAVAIL_STR,
        ENETDOWN_STR, ENETUNREACH_STR, ENETRESET_STR, ECONNABORTED_STR, ECONNRESET_STR,
        ENOBUFS_STR, EISCONN_STR, ENOTCONN_STR, ESHUTDOWN_STR, ETOOMANYREFS_STR,
        ETIMEDOUT_STR, ECONNREFUSED_STR, ELOOP_STR, ENAMETOOLONG_STR, EHOSTDOWN_STR,
        ENOROUTE_STR, ENOTEMPTY_STR, EPROCLIM_STR, EUSERS_STR, EDQUOT_STR, ESTALE_STR,
        EREMOTE_STR, EBADRPC_STR, ERPCMISMATCH_STR, EPROGUNAVAIL_STR, EPROGMISMATCH_STR,
        EPROCUNAVAIL_STR, ENOLCK_STR, ENOSYS_STR, EFTYPE_STR, EAUTH_STR, ENEEDAUTH_STR,
        EPWROFF_STR, EDEVERR_STR, EOVERFLOW_STR, EBADEXEC_STR, EBADARCH_STR, ESHLIBVERS_STR,
        EBADMACHO_STR, ECANCELED_STR, EIDRM_STR, ENOMSG_STR, EILSEQ_STR, ENOATTR_STR,
        EBADMSG_STR, EMULTIHOP_STR, ENODATA_STR, ENOLINK_STR, ENOSR_STR, ENOSTR_STR,
        EPROTO_STR, ETIME_STR, EOPNOTSUPP_STR, ENOPOLICY_STR, ENOTRECOVERABLE_STR,
        EOWNERDEAD_STR, EQFULL_STR
};